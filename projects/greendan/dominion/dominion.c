...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  switch( card ) {
    ...
    case remodel:
      ...
      if(getCost(choice2) > getCost(j + 2)){
        return -1;
      }

      // This code was incorrect, the above code snippet fixes the bug
    ...
    case steward:
			stewardEffect(currentPlayer, state, choice1, choice2, choice3, handPos);
			return 0;
