...
public class UrlValidator implements Serializable {
    ...
    private static final String IPV6_REGEX = "[0-9a-fA-F:]+"; // do this as separate match because : could cause ambiguity
    // with port prefix
    ...
    // matching
    private static final String USERINFO_FIELD_REGEX = USERINFO_CHARS_REGEX + "+" + // At least one character for the name
