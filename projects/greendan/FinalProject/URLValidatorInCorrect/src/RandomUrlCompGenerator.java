/*
Class: RandomUrlCompGenerator
Author: Daniel Green, greendan@oregonstate.edu
Last Modified: 6 June 2019
Description: This class is responsible for generating random URL components. It follows the input boundries described in the
            project documentation. Each component is built to ensure roughly 3/4 of all url's fail or test the input boundries.
 */
...
public class RandomUrlCompGenerator {
    ...
    private static String[] path_chars = {"/", "."};
...
//        System.out.println(random_scheme.toString());
    ...
    private String hostname() {
        ...
        if (rand5050()) {
            hostname.append(RandomStringUtils.randomAlphanumeric(1, 36));
        }
        ...
        if (rand5050()) {
            hostname.append(RandomStringUtils.randomAlphanumeric(1, 100));
        }
    ...
    private String tld() {
        ...
        tld.append(".");
        if (rand5050()) {
            tld.append(GENERIC_TLDS[randNum(0, GENERIC_TLDS.length)]);
        } else {
            tld.append(RandomStringUtils.randomAlphabetic(1, 12));
        }
